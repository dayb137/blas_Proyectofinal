...
urlpatterns = [
     ...
     path('servicios/<int:pk>/actualizar',views.EditarPubli.as_view(), name='editar_publi'),
     path('servicios/<int:pk>/eliminar',views.EliminarPubli.as_view(), name='eliminar_publi'),
